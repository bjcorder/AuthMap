...
| `django_dynamic_settings_default` | DRF settings defaults are dynamic, reassigned, conditionally executed, unpacked, or ambiguous; affected routes receive review-only context |
