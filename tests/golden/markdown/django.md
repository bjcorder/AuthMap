...
- Mutations: 5
- Diagnostics: 5
- Frameworks: django: 5, django_rest_framework: 8
...
| [route_0008](#route-route_0008) | GET &lt;dynamic&gt; | confidence is medium; DRF router prefix is dynamic and was emitted as &lt;dynamic&gt;; DRF router basename is dynamic |
| [route_0009](#route-route_0009) | ANY /accounts | risk is high |
| [route_0010](#route-route_0010) | ANY /accounts/users/&lt;int:pk&gt;/ | risk is review_required; coverage is unknown_or_dynamic |
| [route_0011](#route-route_0011) | ANY &lt;dynamic&gt; | confidence is medium; Django URL path is dynamic and was emitted as &lt;dynamic&gt;; risk is high |
| [route_0012](#route-route_0012) | ANY /status/ | risk is high |
| [route_0013](#route-route_0013) | ANY /^legacy/(?P&lt;slug&gt;\[-\w\]+)/$ | Django re_path regex literal preserved as route path; risk is high |
| diagnostic | drf_dynamic_basename | DRF router basename is dynamic and could not be resolved at tests/fixtures/django/accounts/urls.py:8:1 |
| diagnostic | drf_dynamic_router_prefix | DRF router registration prefix is dynamic and could not be resolved at tests/fixtures/django/accounts/urls.py:8:17 |
| diagnostic | django_custom_router | DRF custom router behavior could not be resolved statically at tests/fixtures/django/accounts/urls.py:10:17 |
...
| diagnostic | django_dynamic_url_path | Django URL path is dynamic and could not be resolved at tests/fixtures/django/accounts/urls.py:16:10 |
...
| [route_0008](#route-route_0008) | django_rest_framework | GET | &lt;dynamic&gt; | \`DynamicViewSet.list\` (tests/fixtures/django/accounts/views.py:57:9) | none | medium | unauthenticated | low |
| [route_0009](#route-route_0009) | django | ANY | /accounts | \`index\` (tests/fixtures/django/accounts/views.py:20:5) | none | high | unauthenticated | high |
| [route_0010](#route-route_0010) | django | ANY | /accounts/users/&lt;int:pk&gt;/ | \`AccountDetailView\` (tests/fixtures/django/accounts/views.py:28:7) | none | high | unknown_or_dynamic | review_required |
| [route_0011](#route-route_0011) | django | ANY | &lt;dynamic&gt; | \`dynamic_view\` (tests/fixtures/django/accounts/views.py:24:5) | none | medium | unauthenticated | high |
| [route_0012](#route-route_0012) | django | ANY | /status/ | \`status\` (tests/fixtures/django/accounts/views.py:12:5) | none | high | unauthenticated | high |
| [route_0013](#route-route_0013) | django | ANY | /^legacy/(?P&lt;slug&gt;\[-\w\]+)/$ | \`legacy_detail\` (tests/fixtures/django/accounts/views.py:16:5) | none | high | unauthenticated | high |
...
### route_0008 GET `&lt;dynamic&gt;`

- Framework: django_rest_framework
- Handler: `DynamicViewSet.list` (tests/fixtures/django/accounts/views.py:57:9)
...
### route_0009 ANY `/accounts`

- Framework: django
- Handler: `index` (tests/fixtures/django/accounts/views.py:20:5)
- Route location: tests/fixtures/django/accounts/urls.py:13:5
- Middleware: none
- Confidence: high
- Coverage: unauthenticated (high)
...
- Coverage support: mutations: mutation_0001; links: link_0003; sensitivity: account_path, any_method, linked_mutation, unsafe_method
- Reviewer questions:
  - Should linked data mutations have resource-specific authorization evidence?
  - Should this route require ownership or permission checks?
  - Should this state-changing route require more than authentication?
...
### route_0010 ANY `/accounts/users/&lt;int:pk&gt;/`

- Framework: django
- Handler: `AccountDetailView` (tests/fixtures/django/accounts/views.py:28:7)
- Route location: tests/fixtures/django/accounts/urls.py:14:5
- Middleware: none
- Confidence: high
...
- Coverage support: evidence: evidence_0002; weak evidence: evidence_0002; mutations: mutation_0002, mutation_0003; links: link_0004, link_0005, link_0006; sensitivity: account_path, any_method, linked_mutation, path_param, unsafe_method, user_path
- Reviewer questions:
...
### route_0013 ANY `/^legacy/(?P&lt;slug&gt;\[-\w\]+)/$`
...
| --- | --- | --- | --- |
| warning | drf_dynamic_basename | tests/fixtures/django/accounts/urls.py:8:1 | DRF router basename is dynamic and could not be resolved |
| warning | drf_dynamic_router_prefix | tests/fixtures/django/accounts/urls.py:8:17 | DRF router registration prefix is dynamic and could not be resolved |
| warning | django_custom_router | tests/fixtures/django/accounts/urls.py:10:17 | DRF custom router behavior could not be resolved statically |
...
| warning | django_dynamic_url_path | tests/fixtures/django/accounts/urls.py:16:10 | Django URL path is dynamic and could not be resolved |
