...
| [route_0010](#route-route_0010) | PATCH /exported/audit | risk is review_required; coverage is unknown_or_dynamic |
...
| [route_0010](#route-route_0010) | express | PATCH | /exported/audit | \`exportAudit\` (tests/fixtures/express/routes/exported.ts:9:10) | \`audit\` (tests/fixtures/express/routes/exported.ts:5:10) | high | unknown_or_dynamic | review_required |
...
- Coverage rationale: 1 strong authorization evidence item(s) were detected.
- Auth evidence:
